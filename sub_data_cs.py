...
def retrieve_data_by_bid_item_num(bid_item_num):
    try:
        ...
        with sqlite3.connect(db_file) as conn:
            ...
            if data:
                # Create and return a SubConditionStateData object with the retrieved data
                bid_item_description, unit_of_measure, avg_unit_price = data
                return SubConditionStateData(bid_item_num, bid_item_description, unit_of_measure, avg_unit_price)
            else:
                return None
