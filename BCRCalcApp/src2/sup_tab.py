...
from sup_dynamic_row import SupDynamicRow
# from database import Database
from tkinter import messagebox

class SupTab(ttk.Frame):
    ...
    def create_bottom_total_cost_area(self,param_relx=0, param_rely=0.9, param_relwidth=1, param_relheight=0.1):
        ...
        # Reset button
        self.reset_button = ttk.Button(self.final_cost_area, text="Reset", command=self.reset_sup_tab)
    ...
    def add_row(self):
        ...
        row = SupDynamicRow(self ,self.calculation_form_area, self.controller,self.bridgeId,self.uuid,)
        row.pack()
    ...
    def store_to_db(self):
        try:
            ...
            self.database.insert_bridge_sup_calc_hist(self.bridgeId, self.uuid, final_cost)
            messagebox.showinfo("Success", "Sup Final Cost stored to DB!")
